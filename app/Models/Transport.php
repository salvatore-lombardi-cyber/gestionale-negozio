...
class Transport extends Model
{
    ...
    {
        // OWASP: Sanitizzazione rigorosa del codice trasporto
    ...
    {
        // OWASP: Sanitizzazione del nome trasportatore
    ...
    // OWASP: Validazione regole complete per trasporti
    public static function validationRules(): array
    {
        return [
            'code' => 'required|string|max:20|unique:transports,code|regex:/^[A-Z0-9_-]+$/',
    ...
    public static function validationRulesForUpdate(int $id): array
    {
        ...
        $rules['code'] = 'required|string|max:20|unique:transports,code,' . $id . '|regex:/^[A-Z0-9_-]+$/';
        return $rules;
    }
