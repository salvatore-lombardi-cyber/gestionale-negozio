...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $existingData = \DB::table('customer_categories')->select('code', 'description')->get();
        ...
        Schema::create('customer_categories', function (Blueprint $table) {
            $table->id();
            $table->string('code', 20)->unique()->comment('Codice categoria cliente');
            $table->text('description')->comment('Descrizione categoria cliente');
            $table->timestamps();
        });
