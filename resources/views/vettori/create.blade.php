...
@section('title', 'Nuovo Vettore - Gestionale Negozio')
...
<div class="create-container">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="page-title">
                <i class="bi bi-truck"></i> Nuovo Vettore
            </h1>
            <a href="{{ route('vettori.index') }}" class="btn btn-secondary modern-btn">
                <i class="bi bi-arrow-left"></i> Torna all'Elenco
            </a>
        </div>
        <p class="text-muted mt-2 mb-0">Aggiungi un nuovo vettore/spedizioniere al sistema</p>
    </div>

    <form method="POST" action="{{ route('vettori.store') }}" novalidate>
        @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="codice_vettore" class="form-control modern-input @error('codice_vettore') is-invalid @enderror" 
                           value="{{ old('codice_vettore') }}" required maxlength="10" style="text-transform: uppercase;">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="tipo_vettore" class="form-control modern-select @error('tipo_vettore') is-invalid @enderror" required>
                        <option value="">Seleziona tipo</option>
                        <option value="corriere_espresso" {{ old('tipo_vettore', 'corriere_espresso') == 'corriere_espresso' ? 'selected' : '' }}>Corriere Espresso</option>
                        <option value="trasporto_standard" {{ old('tipo_vettore') == 'trasporto_standard' ? 'selected' : '' }}>Trasporto Standard</option>
                        <option value="trasporto_pesante" {{ old('tipo_vettore') == 'trasporto_pesante' ? 'selected' : '' }}>Trasporto Pesante</option>
                        <option value="logistica_integrata" {{ old('tipo_vettore') == 'logistica_integrata' ? 'selected' : '' }}>Logistica Integrata</option>
                        <option value="posta_ordinaria" {{ old('tipo_vettore') == 'posta_ordinaria' ? 'selected' : '' }}>Posta Ordinaria</option>
                    </select>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="classe_vettore" class="form-control modern-select @error('classe_vettore') is-invalid @enderror" required>
                        <option value="standard" {{ old('classe_vettore', 'standard') == 'standard' ? 'selected' : '' }}>Standard</option>
                        <option value="premium" {{ old('classe_vettore') == 'premium' ? 'selected' : '' }}>Premium</option>
                        <option value="economico" {{ old('classe_vettore') == 'economico' ? 'selected' : '' }}>Economico</option>
                        <option value="occasionale" {{ old('classe_vettore') == 'occasionale' ? 'selected' : '' }}>Occasionale</option>
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="costo_base_kg" class="form-control modern-input @error('costo_base_kg') is-invalid @enderror" 
                               value="{{ old('costo_base_kg') }}" min="0" step="0.01">
                    </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="costo_minimo_spedizione" class="form-control modern-input @error('costo_minimo_spedizione') is-invalid @enderror" 
                               value="{{ old('costo_minimo_spedizione') }}" min="0" step="0.01">
                    </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="soglia_franco" class="form-control modern-input @error('soglia_franco') is-invalid @enderror" 
                               value="{{ old('soglia_franco') }}" min="0" step="0.01">
                    </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="tempo_consegna_standard" class="form-control modern-input @error('tempo_consegna_standard') is-invalid @enderror" 
                           value="{{ old('tempo_consegna_standard') }}" min="1" max="30">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="tempo_consegna_express" class="form-control modern-input @error('tempo_consegna_express') is-invalid @enderror" 
                           value="{{ old('tempo_consegna_express') }}" min="1" max="10">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="percentuale_puntualita" class="form-control modern-input @error('percentuale_puntualita') is-invalid @enderror" 
                           value="{{ old('percentuale_puntualita') }}" min="0" max="100" step="0.01">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" name="api_tracking_url" class="form-control modern-input @error('api_tracking_url') is-invalid @enderror" 
                           value="{{ old('api_tracking_url') }}" placeholder="https://tracking.corriere.it/track/{tracking}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="codice_tracking_prefisso" class="form-control modern-input @error('codice_tracking_prefisso') is-invalid @enderror" 
                           value="{{ old('codice_tracking_prefisso') }}" maxlength="10">
        ...
        <div class="d-flex justify-content-between">
            ...
            <button type="submit" class="modern-btn">
                <i class="bi bi-check-circle"></i> Crea Vettore
            </button>
        </div>
    </form>
</div>
