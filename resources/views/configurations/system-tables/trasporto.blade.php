...
<div class="management-container">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="d-flex align-items-center">
                <h1 class="management-title">
                    <i class="bi bi-truck me-3" style="color: #636e72; font-size: 2rem;"></i>
                    Trasporto
                </h1>
            </div>
            <div class="d-flex gap-2">
                ...
                <button type="button" class="btn btn-success modern-btn" data-bs-toggle="modal" data-bs-target="#createModal">
                    <i class="bi bi-plus-lg"></i> Nuovo Trasporto
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="table-container">
        <div class="table-responsive">
            <table class="modern-table" id="transportTable">
                <thead>
                    <tr>
                        <th>CODICE</th>
                        <th>NOME</th>
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 20px; border: none;">
            <div class="modal-header" style="background: linear-gradient(135deg, #636e72, #2d3436); color: white; border-radius: 20px 20px 0 0;">
                <h5 class="modal-title">
                    <i class="bi bi-truck me-2"></i>
                    <span id="modalTitle">Nuovo Trasporto</span>
                </h5>
                ...
                <div class="modal-body" style="padding: 2rem;">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <small class="form-text text-muted">Es: DHL, UPS, SDA, BARTOL, PROPRIO</small>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3" maxlength="500" placeholder="Descrizione dettagliata del trasporto (opzionale)"></textarea>
...
function confirmDelete(id, code) {
    if (confirm(`Sei sicuro di voler eliminare il trasporto "${code}"?\n\nQuesta azione non può essere annullata.`)) {
...
function saveTransport() {
    ...
    .catch(error => {
        ...
        alert('Errore durante il salvataggio del trasporto');
    });
}

function resetCreateForm() {
    editingId = null;
    document.getElementById('modalTitle').textContent = 'Nuovo Trasporto';
