...
<div class="management-container">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="d-flex align-items-center">
                <h1 class="management-title">
                    <i class="bi bi-person-badge me-3" style="color: #3742fa; font-size: 2rem;"></i>
                    Trasporto a Mezzo
                </h1>
            </div>
            <div class="d-flex gap-2">
                ...
                <button type="button" class="btn btn-success modern-btn" data-bs-toggle="modal" data-bs-target="#createModal">
                    <i class="bi bi-plus-lg"></i> Nuovo Trasporto a Mezzo
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="table-container">
        <div class="table-responsive">
            <table class="modern-table" id="transportCarrierTable">
                <thead>
                    <tr>
                        <th>CODICE</th>
                        <th>NOME</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="empty-state">
                                ...
                                <h4>Nessun trasporto trovato</h4>
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 20px; border: none;">
            <div class="modal-header" style="background: linear-gradient(135deg, #3742fa, #2f3542); color: white; border-radius: 20px 20px 0 0;">
                <h5 class="modal-title">
                    <i class="bi bi-person-badge me-2"></i>
                    <span id="modalTitle">Nuovo Trasporto a Mezzo</span>
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <form id="transportCarrierForm">
                <div class="modal-body" style="padding: 2rem;">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <small class="form-text text-muted">Es: DHL-EX, UPS-STD, SDA-EX, BARTOL, FEDEX</small>
                        </div>
                        <div class="col-md-6">
                            <label for="name" class="form-label">Nome *</label>
                            <input type="text" class="form-control" id="name" name="name" required maxlength="150">
                            <div class="invalid-feedback" id="nameError"></div>
                            <small class="form-text text-muted">Nome descrittivo del vettore</small>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3" maxlength="500" placeholder="Descrizione dettagliata del vettore (opzionale)"></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success">
                        ...
                        <span id="submitButtonText">Salva Trasporto</span>
                    </button>
                </div>
            </form>
        </div>
...
function loadEditData(id, code, name, description, active, sortOrder) {
    ...
    document.getElementById('modalTitle').textContent = 'Modifica Trasporto';
    document.getElementById('submitButtonText').textContent = 'Aggiorna Trasporto';
...
function confirmDelete(id, code) {
    if (confirm(`Sei sicuro di voler eliminare il vettore "${code}"?\n\nQuesta azione non può essere annullata.`)) {
...
// Salva trasporto
function saveTransportCarrier() {
    const form = document.getElementById('transportCarrierForm');
    ...
    .catch(error => {
        ...
        alert('Errore durante il salvataggio del vettore');
    });
}

function resetCreateForm() {
    editingId = null;
    document.getElementById('modalTitle').textContent = 'Nuovo Trasporto a Mezzo';
    document.getElementById('submitButtonText').textContent = 'Salva Trasporto';
    document.getElementById('transportCarrierForm').reset();
    document.querySelectorAll('.is-invalid').forEach(el => el.classList.remove('is-invalid'));
    document.querySelectorAll('.invalid-feedback').forEach(el => el.textContent = '');
