...
<div class="management-container">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="d-flex align-items-center">
                <h1 class="management-title">
                    <i class="bi bi-credit-card me-3" style="color: #fdcb6e; font-size: 2rem;"></i>
                    Tipo di Pagamento
                </h1>
            </div>
            <div class="d-flex gap-2">
                ...
                <button type="button" class="btn btn-success modern-btn" data-bs-toggle="modal" data-bs-target="#createModal">
                    <i class="bi bi-plus-lg"></i> Nuovo Tipo di Pagamento
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="table-container">
        <div class="table-responsive">
            <table class="modern-table" id="paymentTypeTable">
                <thead>
                    <tr>
                        <th>CODICE</th>
                        <th>NOME</th>
                        ...
                        <tr data-active="{{ $item->active ? '1' : '0' }}">
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button type="button" class="action-btn edit" title="Modifica tipo" onclick="loadEditData({{ $item->id }}, '{{ $item->code }}', '{{ $item->name }}', '{{ addslashes($item->description ?? '') }}', {{ $item->active ? 'true' : 'false' }}, {{ $item->sort_order ?? 0 }})">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="empty-state">
                                ...
                                <h4>Nessun tipo di pagamento trovato</h4>
...
<!-- Modal Tipo di Pagamento -->
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 20px; border: none;">
            <div class="modal-header" style="background: linear-gradient(135deg, #fdcb6e, #e17055); color: white; border-radius: 20px 20px 0 0;">
                <h5 class="modal-title">
                    <i class="bi bi-credit-card me-2"></i>
                    <span id="modalTitle">Nuovo Tipo di Pagamento</span>
                </h5>
            ...
            <form id="paymentTypeForm">
                <div class="modal-body" style="padding: 2rem;">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <small class="form-text text-muted">Es: CONT, BONIF, CARTA, ASSEGNO, PAYPAL</small>
                        </div>
                        <div class="col-md-6">
                            <label for="name" class="form-label">Nome *</label>
                            <input type="text" class="form-control" id="name" name="name" required maxlength="150">
                            <div class="invalid-feedback" id="nameError"></div>
                            <small class="form-text text-muted">Nome descrittivo del tipo di pagamento</small>
                        </div>
                    </div>
                    
                    <div class="mb-3">
                        <label for="description" class="form-label">Descrizione</label>
                        <textarea class="form-control" id="description" name="description" rows="3" maxlength="500" placeholder="Descrizione dettagliata del tipo di pagamento (opzionale)"></textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="form-text text-muted">Solo tipi di pagamento attivi sono disponibili</small>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success">
                        ...
                        <span id="submitButtonText">Salva Tipo di Pagamento</span>
                    </button>
                </div>
            </form>
        </div>
...
function loadEditData(id, code, name, description, active, sortOrder) {
    ...
    document.getElementById('modalTitle').textContent = 'Modifica Tipo di Pagamento';
    document.getElementById('submitButtonText').textContent = 'Aggiorna Tipo di Pagamento';
...
function confirmDelete(id, code) {
    if (confirm(`Sei sicuro di voler eliminare il tipo di pagamento "${code}"?\n\nQuesta azione non può essere annullata.`)) {
...
function savePaymentType() {
    ...
    .catch(error => {
        ...
        alert('Errore durante il salvataggio del tipo di pagamento');
    });
}

function resetCreateForm() {
    editingId = null;
    document.getElementById('modalTitle').textContent = 'Nuovo Tipo di Pagamento';
    document.getElementById('submitButtonText').textContent = 'Salva Tipo di Pagamento';
