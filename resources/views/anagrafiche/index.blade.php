...
<div class="floating-elements">
    <i class="bi bi-person-lines-fill floating-element"></i>
...
<div class="container-fluid anagrafiche-container">
    <div class="row">
        <div class="col-12">
            <!-- Header della pagina Anagrafiche -->
            <div class="anagrafiche-header text-center">
                <h1 class="anagrafiche-title">
                    <i class="bi bi-person-lines-fill"></i> {{ __('app.anagrafiche') }}
                </h1>
                <p class="welcome-text">{{ __('app.anagrafiche_welcome') }}</p>
            </div>
            
            <!-- Cards delle Anagrafiche -->
            <div class="row g-4">
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="stats-card primary pulse-animation">
                        ...
                        <a href="{{ route('clienti.index') }}" class="stats-btn primary">
