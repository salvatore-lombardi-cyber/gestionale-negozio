...
@section('title', 'Modifica Fornitore - Gestionale Negozio')
...
<div class="create-container">
    ...
    <div class="page-header">
        ...
        <p class="text-muted mt-2 mb-0">Modifica i dati del fornitore {{ $fornitore->nome_completo }}</p>
    </div>

    <form method="POST" action="{{ route('fornitori.update', $fornitore) }}" novalidate>
        @csrf
        @method('PUT')
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="tipo_soggetto" class="form-control modern-select @error('tipo_soggetto') is-invalid @enderror" required>
                        ...
                        <option value="persona_giuridica" {{ old('tipo_soggetto', $fornitore->tipo_soggetto) == 'persona_giuridica' ? 'selected' : '' }}>Azienda / Persona Giuridica</option>
                        <option value="persona_fisica" {{ old('tipo_soggetto', $fornitore->tipo_soggetto) == 'persona_fisica' ? 'selected' : '' }}>Persona Fisica</option>
                        <option value="ente_pubblico" {{ old('tipo_soggetto', $fornitore->tipo_soggetto) == 'ente_pubblico' ? 'selected' : '' }}>Ente Pubblico</option>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="categoria_merceologica" class="form-control modern-input @error('categoria_merceologica') is-invalid @enderror" 
                           value="{{ old('categoria_merceologica', $fornitore->categoria_merceologica) }}" placeholder="es. Elettronica, Abbigliamento">
            ...
            <div class="row" id="persona-fisica-fields" style="display: none;">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" name="data_nascita" class="form-control modern-input @error('data_nascita') is-invalid @enderror" 
                           value="{{ old('data_nascita', $fornitore->data_nascita?->format('Y-m-d')) }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="codice_fiscale" class="form-control modern-input @error('codice_fiscale') is-invalid @enderror" 
                           value="{{ old('codice_fiscale', $fornitore->codice_fiscale) }}" required maxlength="16" style="text-transform: uppercase;">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="partita_iva" class="form-control modern-input @error('partita_iva') is-invalid @enderror" 
                           value="{{ old('partita_iva', $fornitore->partita_iva) }}" maxlength="11" pattern="[0-9]{11}">
        ...
        <div class="d-flex justify-content-between">
            ...
            <button type="submit" class="modern-btn">
                <i class="bi bi-check-circle"></i> Aggiorna Fornitore
            </button>
        </div>
    </form>
</div>
